...
<head>
    ...
    <!-- Your CSS File -->
    <link rel="stylesheet" href="/src/styles/student/student-results.css"> <!-- Write your CSS in this file alrady created for you -->
    ...
    <main>
        <nav>
            ...
            <ul class="nav-links">
                ...
                <li><a href="results.html" class="active"><span class="material-symbols-rounded">school</span> Results</a></li>
        ...
        <section>
            ...
            <div class="container">
                <div class="title">
                    <p class="text-body-300 weight-600 font-size-5">Results</p>
                </div>
