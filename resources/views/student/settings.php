...
<head>
    ...
    <!-- Your CSS File -->
    <link rel="stylesheet" href="/src/styles/student/student-settings.css"> <!-- Write your CSS in this file alrady created for you -->
    ...
    <main>
        <nav>
            ...
            <ul class="nav-links">
                ...
                <li><a href="settings.html" class="active"><span class="material-symbols-rounded">settings</span> Settings</a></li>
        ...
        <section>
            ...
            <div class="small-screen-nav-content">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="results.html"><span class="material-symbols-rounded">school</span> Results</a></li>
                    <li><a href="profile.html"><span class="material-symbols-rounded">account_circle</span> Profile</a></li>
                    <li><a href="settings.html" class="active"><span class="material-symbols-rounded">settings</span> Settings</a>
                    </li>
                    <li><a href="/index.html"><span class="material-symbols-rounded">logout</span> Logout</a></li>
                </ul>
            </div>
            <div class="container">
                ...
                <div class="title">
                    <p class="text-body-300 weight-600 font-size-5">Settings</p>
                </div>
